...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center h-12 md:h-16 bg-slate-800 text-white p-4'>
            ...
            {!session && <div>
                <Link href="/login">
                    <button type="button" className="text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-3 py-1.5 md:px-5 md:py-2.5 text-center">Login</button>
                </Link>
            </div>}

...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-4 py-8">
            <h1 className="text-2xl md:text-4xl underline font-semibold mb-4">About Get Me a Chai</h1>
            <p className="md:text-lg mb-6 text-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/group.gif" alt="Fans Want to Collaborate" />
                        <div>
                        <h3 className="text-lg md:text-xl font-semibold mb-2">Fans Want to Collaborate</h3>
            ...
            <div className='container mx-auto md:px-4 py-8'>
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Benefits for Creators</h2>
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Benefits for Fans</h2>
                <ul className="list-disc pl-6 mb-6">
                ...
                {/* Additional sections */}
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Benefits of Collaboration</h2>
                <ul className="list-disc pl-6 mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Community Engagement</h2>
                <ul className="list-disc pl-6 mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Access to Resources</h2>
                <ul className="list-disc pl-6 mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Recognition and Exposure</h2>
                <ul className="list-disc pl-6 mb-6">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mb-4">Supportive Community</h2>
                <ul className="list-disc pl-6 mb-6">
